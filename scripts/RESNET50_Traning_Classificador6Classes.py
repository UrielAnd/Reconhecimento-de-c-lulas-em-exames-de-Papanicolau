...
# Mapeamento de subpastas para rótulos de múltiplas classes
label_map = {
    'SCC': 1,
    'LSIL': 2,
    'ASC-H': 3,
...
# Definir callbacks
checkpoint = ModelCheckpoint('resnet50_best_model_6_classes.keras', monitor='val_accuracy', save_best_only=True, mode='max')
