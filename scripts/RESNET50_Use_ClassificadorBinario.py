...
# Carregar o modelo treinado com TensorFlow Keras (ResNet50)
MODEL = load_model('models/resnet50_best_model.keras')
    ...
    for subdir, _, files in os.walk(INPUT_DIR):
        for file in files:
            if file.lower().endswith(('jpg', 'jpeg', 'png')):  # Ajuste conforme necessário
                ...
                # Fazer a previsão usando o modelo ResNet50
                ...
                pred = "Negativo" if predicted_class == 0 else "Positivo"
...
if __name__ == "__main__":
    # Mapeamento de classes preditas para rótulos
    label_map = {
        0: '0',
        1: '1'
    }
